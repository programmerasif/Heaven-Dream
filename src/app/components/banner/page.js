      ...
      <div className='banner h-[75vh] md:h-[100vh] relative'>
        <div className='text-white  flex flex-col  justify-center items-center h-full px-2 gap-2 mb:gap-5'>
          ...
          Wellcome to our Heaven-Dearm
            ...
            <div className='text-3xl font-semibold absolute bottom-10 flex rounded-lg'>
            <span className='bg-[#0f172b] text-sm md:text-4xl font-semibold px-4  md:px-14 flex justify-center items-center gap-2 hover:bg-gray-200 hover:text-[#ffa000] duration-300'><span className='animate-pulse '> <FaPhoneVolume /> </span> <span>Call Now</span> </span>
